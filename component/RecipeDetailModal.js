...
// 				<TextInput style={styles.input} value={newRecipeName} onChangeText={setNewRecipeName} multiline={true} />
// 				<TextInput style={styles.inputDetails} value={newIngredients} onChangeText={setNewRecipeIngredients} placeholder="Ingredients" multiline={true} />
